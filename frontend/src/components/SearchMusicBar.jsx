...
export const MusicSearchBar = ({ searchData, resetFilter }) => {
    ...
    return (
        <Flex justifyContent="space-between" alignItems="center">
            ...
            <InputGroup borderRadius={5} size="sm" width="350px">
                ...
                <Input type="text" placeholder="Pesquise por músicas" border="1px solid #949494" value={searchValue} onChange={(e) => setSearchValue(e.target.value)} />
